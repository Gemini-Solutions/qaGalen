...
public class GalenLayoutTesting extends GalenJUnitTestBase {
    ...
    public WebDriver createDriver() {
        System.setProperty("webdriver.chrome.driver","C:\\Users\\ho.raj\\Downloads\\chromedriver_win32 105\\chromedriver.exe");
    ...
    public void testHowItWorksPage() throws Exception {
        ...
        driver.findElement(By.xpath("//li[@class='nav-item col-lg-auto']/a[text()='HOW IT WORKS ']")).click();
